...
export default async function handler(req, res) {
  ...
  const { error } = await resend.emails.send({
    ...
    to: email,
    subject: "Welcome to PromptUpp ⚡",
    html: `
      <div style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:40px 24px;background:#fff;">
        <div style="margin-bottom:32px;">
          <span style="background:#4f46e5;color:#fff;font-weight:900;font-size:14px;padding:6px 12px;border-radius:8px;">⚡ PromptUpp</span>
        </div>
        ...
        <p style="font-size:16px;color:#52525b;line-height:1.6;margin:0 0 24px;">
          Welcome to PromptUpp — 8,000+ professional AI prompts, ready to copy and paste.
          No more vague AI responses. Just real, usable output.
        </p>
        <a href="https://www.promptupp.com/library"
        ...
        <p style="font-size:13px;color:#a1a1aa;margin:0;">
          You're receiving this because you signed up at promptupp.com.<br/>
