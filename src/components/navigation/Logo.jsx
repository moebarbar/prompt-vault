...
export const Logo = () => (
  <Link href="/" className="flex items-center gap-2 mr-8">
    ...
    <span className="font-black text-lg tracking-tight hidden md:block">PromptVault</span>
  </Link>
);
...
export const LogoSmall = () => (
  <Link href="/" className="flex items-center gap-1.5">
    ...
    <span className="font-black text-sm tracking-tight">PromptVault</span>
  </Link>
);
...
export const LogoLarge = () => (
  <Link href="/" className="flex items-center gap-3 mb-6">
    ...
    <span className="font-black text-3xl tracking-tight">PromptVault</span>
  </Link>
);
